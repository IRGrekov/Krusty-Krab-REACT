...
describe('burger-constructor reducer test', () => {
  ...
  it('should handle replace bun', () => {
    expect(
      reducer({ ...state, bunsList: [fluorescentBun] }, setBun(craterBun))
    ).toEqual({
      ...state,
      bunsList: [craterBun],
    })
  ...
  it('should handle add ingredient', () => {
    expect(reducer(state, addIngredient(ingredientSauce))).toEqual({
      ...state,
  ...
  it('should handle add another ingredient', () => {
    expect(
      reducer(
        { ...state, mainList: [ingredientSauce] },
  ...
  it('should handle move ingredient', () => {
    expect(
      reducer(
        {
          ...state,
          mainList: [ingredientSauce, ingredientSauce, ingredientMain],
        },
  ...
  it('should handle delete ingredient', () => {
    expect(
      reducer(
        { ...state, mainList: [ingredientSauce, ingredientMain] },
