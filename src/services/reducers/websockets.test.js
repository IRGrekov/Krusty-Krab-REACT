...
describe('websockets reducer test', () => {
  ...
  it('should handle ws get all orders', () => {
    expect(wsReducer(initialState, wsGetOrderds(allOrders))).toEqual({
      ...initialState,
...
describe('user websockets reducer test', () => {
  it('should handle user ws connection success', () => {
    expect(wsUserReducer(initialStateUser, wsConnectionSuccessUser())).toEqual({
      ...initialStateUser,
      wsConnection: true,
    })
  })
  it('should handle user ws connection error', () => {
    expect(wsUserReducer(initialStateUser, wsConnectionErrorUser())).toEqual({
      ...initialStateUser,
      wsConnection: false,
    })
  })
  it('should return the initial state user if ws connection closed', () => {
    expect(wsUserReducer(initialStateUser, wsConnectionClosedUser())).toEqual(
      initialStateUser
    )
  })
  it('should handle ws get user orders', () => {
    expect(
      wsUserReducer(initialStateUser, wsGetOrderdsUser(userOrders))
    ).toEqual({
      ...initialStateUser,
